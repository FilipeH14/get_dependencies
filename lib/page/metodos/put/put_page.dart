...
import 'package:get_depedencias/page/metodos/put/put_controller.dart';
import 'package:get_depedencias/page/metodos/put/put_controller_permanente.dart';
import 'package:get_depedencias/page/metodos/put/put_controller_tag.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('Times put: ${controller.timestamp}'),
            Text('Times put: ${controller2.timestamp}'),
            const WidgetInterno(),
          ],
        ),
      ),
